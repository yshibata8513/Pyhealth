...
PyTorch re-implementation of the BulkRNABert architecture from
Gelard et al., 2024 (https://arxiv.org/abs/2407.18121), originally released
in JAX/Haiku at https://github.com/instadeepai/multiomics-open-research under
CC BY-NC-SA 4.0. This file is an independent clean-room implementation written
from the paper and public specifications; no source code has been copied from
the original repository. This file is MIT-licensed, matching PyHealth.
...
def bin_expression_values(
    ...
    Args:
        ...
        normalization_factor: Scalar used as the upper bound of the value range
            before binning. The default of 5.547 matches the reference
            implementation which estimated this from the TCGA corpus.
...
class TransformerEncoderBlock(nn.Module):
    ...
    Uses ``nn.MultiheadAttention`` (batch_first=True) and a GELU feed-forward
    sub-layer. Dimensions match the reference paper: ``embed_dim=256``,
    ``num_heads=8``, ``ffn_embed_dim=512``.
    """
